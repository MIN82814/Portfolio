export const serviceCardContent = [
  {
    zhTitle: "前端開發",
     ...
     skills: [
      {
        title: "React.js",
        content: "具備 React 開發實務經驗，<strong>Hooks、元件化架構</strong>設計與狀態管理模式，能規劃高可維護性與高重用性的前端應用架構。"
      },
      {
        title: "Redux Toolkit",
      ...
      },
       {
        ...
        content: "非同步處理、DOM 操作與資料邏輯拆解。"
         ...
         {
        title: "API 資料串接",
        content: "具備前後端整合經驗，<strong>Axios 串接 RESTful API </strong>、資料轉換處理、錯誤攔截與例外管理機制。"
      },
       {
        title: "Chart.js",
        content: "數據視覺化開發經驗。"
    ...
    zhTitle: "介面切版實作",
     ...
     skills: [
      {
        title: "RWD 響應式網頁",
        content: "具備多年企業網站切版經驗，<strong>熟悉跨裝置與跨瀏覽器相容性設計</strong>，能確保最佳使用體驗。 "
      },
      {
        title: "Bootstrap5 / SCSS",
        content: "CSS 架構規劃與樣式模組化管理，具備<strong>專案樣式維護與元件化開發</strong>經驗。"
      },
       {
        title: "動態特效與互動",
        content: "具備動畫與互動效果開發經驗， <strong>Swiper、AOS、SVG、Animation、Icon Font</strong> 等前端技術應用。"
      },
       {
        title: "UI/UX 轉譯",
        content: "能與 UI／UX 設計師協作，將設計稿高品質轉譯為實際產品介面，兼顧美觀性、互動性與開發效率。"
         ...
         {
        title: "系統維護與優化",
        content: "具備既有<strong>網站維護</strong>、跨瀏覽器相容性與效能調整經驗。"
      },
    ],
  },
     {
    zhTitle: "設計工具與開發流程",
     ...
     skills: [
      ...
      },
      {
       ...
       {
        title: "Git / GitHub",
        content: "Git Flow 開發流程、版本控管與團隊協作模式，具備 <strong>Pull Request 與分支管理實務經驗。</strong>"
      },
       {
        title: "開發環境建置",
        content: "熟悉 NPM、Vite 等前端建置工具與開發流程，具備專案建置與維護經驗。"
      },
         {
